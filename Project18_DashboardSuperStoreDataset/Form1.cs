...
namespace Project18_DashboardSuperStoreDataset
{
    public partial class Form1 : Form
    {
        ...
        //SqlConnection sqlConnection = new SqlConnection("Server=LAPTOP-O07DGMRC\\MSSQLSERVER01; initial catalog=Db17Project20;integrated security=true");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //sqlConnection.Open();
            //    SqlCommand command6 = new SqlCommand("Select top(3) Country, sum(Quantity) From Group By Country order by sum(quantity) desc", sqlConnection);
            //    SqlDataReader reader6 = command6.ExecuteReader();
            //    while(reader6.Read())
            //    {
            //         chart2.Series["Series1"].Points.AddXY("Londra", 66);
            //    }
            //    sqlConnection.Close();
            ...
            //    while(reader7.Read())
            //    {
            //         chart3.Series["Series1"].Points.AddXY("Londra", 66);
            //    }
            //    sqlConnection.Close();
