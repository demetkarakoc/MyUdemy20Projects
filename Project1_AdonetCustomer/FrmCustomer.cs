...
namespace Project1_AdonetCustomer
{
    public partial class FrmCustomer : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=LAPTOP-O07DGMRC\\MSSQLSERVER01; initial catalog=DbCustomer;integrated security=true");
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("@customerStatus", rdbActive.Checked);


            if(rdbActive.Checked)
            {
                command.Parameters.AddWithValue("@customerStatusValue", true);
            }

            if (rdbPassive.Checked)
            {
                command.Parameters.AddWithValue("@customerStatusValue", false);
            }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.AddWithValue("@customerSurname", txtCustomerSurname.Text);
            command.Parameters.AddWithValue("@customerCity", cmbCity.SelectedValue);
            command.Parameters.AddWithValue("@customerStatus", rdbPassive.Checked);
            command.Parameters.AddWithValue("@customerBalance", txtBalance.Text);
            command.Parameters.AddWithValue("@customerId", txtCustomerId.Text );
