...
namespace Project16_MailRegister
{
    public partial class Form1 : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            bodyBuilder.TextBody="Email Adresiinizin Konfirmasyon Kodu: "+ confirmCode;
            ...
            MessageBox.Show("Mail adresinize doğrulama kodu başarıyla gönderildi");

            FrmMailConfrim frm = new FrmMailConfrim();
